export const translations = {
  pl: {
    ...
    contact: {
      ...
      message: 'Wiadomość',
      messagePlaceholder: 'Opowiedz nam o swoich potrzebach...',
      isRangeManager: 'Zarządzam strzelnicą',
      ...
      verificationCodeHelp: 'Kod zabezpiecza przed phishingiem i będzie widoczny w emailach od nas',
      getUpdates: 'Otrzymuj aktualizacje',
      subscribing: 'Zapisywanie...',
      newsletterDisabled: 'Newsletter tymczasowo wyłączony',
      reachDirectly: 'Lub skontaktuj się bezpośrednio:',
      thankYouMessage: 'Dziękujemy za wiadomość! Wkrótce się z Tobą skontaktujemy.',
      thankYouSubscribe: 'Dziękujemy za zapisanie się! Zapamiętaj swój kod weryfikacyjny.',
      alreadySubscribed: 'Ten email jest już zapisany.',
      errorMessage: 'Nie udało się wysłać wiadomości. Spróbuj ponownie.',
      errorSubscribe: 'Nie udało się zapisać. Spróbuj ponownie.',
      codeRequired: 'Kod weryfikacyjny jest wymagany.',
    },
  },
  en: {
    nav: {
    ...
    contact: {
      ...
      isRangeManager: 'I manage a range',
      ...
      verificationCodeHelp: 'Code protects against phishing and will be visible in emails from us',
      getUpdates: 'Get Updates',
      subscribing: 'Subscribing...',
      newsletterDisabled: 'Newsletter temporarily disabled',
      reachDirectly: 'Or reach us directly:',
      thankYouMessage: 'Thank you for your message! We will get back to you soon.',
      thankYouSubscribe: 'Thank you for subscribing! Remember your verification code.',
      alreadySubscribed: 'This email is already subscribed.',
      errorMessage: 'Failed to send message. Please try again.',
      errorSubscribe: 'Failed to subscribe. Please try again.',
