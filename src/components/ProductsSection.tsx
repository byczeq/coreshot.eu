    ...
    <section id="products" className="py-24 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <div className="aspect-video bg-gradient-to-br from-[#E11D48]/20 to-[#E11D48]/5 flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/6069057/pexels-photo-6069057.jpeg?auto=compress&cs=tinysrgb&w=800')] bg-cover bg-center opacity-30" />
              <svg
          ...
          >
            <div className="aspect-video bg-gradient-to-br from-[#E11D48]/20 to-[#E11D48]/5 flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800')] bg-cover bg-center opacity-20" />
              <svg
                className="w-32 h-32 text-white/80 relative z-10"
                fill="none"
                stroke="currentColor"
